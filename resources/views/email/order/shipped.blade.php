...
<div class="container">
  <table>
    ...
    <tr>
      <td colspan="4">{{__('message.from')}} : {{ $order->reciever }}</td>
    </tr>
    <tr>
      <td colspan="4">{{__('message.shipped_body')}}</td>
    </tr>
    <tr>
      <td colspan="4">{{__('message.shipped_carrier')}}&nbsp;:&nbsp;{{$data['carrier'] }}</td>
    </tr>
    <tr>
      <td colspan="4">{{__('message.shipped_track')}}&nbsp;:&nbsp;{{$data['tracking_number'] ? $data['tracking_number'] : __('message.not_defined')}}</td>
    </tr>
    ...
    <tr>
      <td colspan="4">
        <ul>
          <li style="font-size:1.2em; color:red;">{{__('message.shipped_warning')}}</li>
