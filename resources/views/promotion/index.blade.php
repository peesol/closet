    ...
    <div class="panel-body">
      <div class="shadow-2 margin-20-bottom">
        ...
        <div class="panel-body">
          ...
          <div class="align-right padding-15-vertical">
            <a class="orange-btn padding-10 normal-sq" href="{{route('promotionCode')}}">{{__('message.proceed')}}</a>
          </div>
        </div>
      </div>
      ...
      <div class="shadow-2">
        ...
        <div class="panel-body">
          ...
          <div class="align-right padding-15-vertical">
            <a class="orange-btn padding-10 normal-sq" href="{{route('promotionDiscount')}}">{{__('message.proceed')}}</a>
          </div>
        </div>
      </div>
    </div>
