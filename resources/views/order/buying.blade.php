  ...
  <div class="medium-panel">
    <div class="tab-nav">
        <ul class="tab-nav-ul static">
            <button class="tab-nav-btn" onclick='document.location.href="{{ url('/order/selling') }}"'>{{ __('message.selling_order')}}</button>
    ...
    <div class="panel-body">
      ...
      <div class="padding-15-vertical">
        <a href="/order/buying/history" class="font-15em">{{ __('message.buying_history') }}>></a>
      </div>
    </div>
  </div>
</div>
