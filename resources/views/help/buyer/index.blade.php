...
<div class="full-width" id="full-line">
  <button class="flat-btn align-left padding-10" id="1">คำแนะนำในการเลือกสินค้า&nbsp;<small class="icon-arrow-down"></small></button>
  <div class="panel padding-15-bottom" id="panel1">
    <ul class="no-margin" style="list-style-type: decimal">
      ...
      <li>ควรเลือกซื้อจากร้านค้าที่ได้รับการยืนยันแล้ว บนรูปสินค้าและชื่อโปรไฟล์จะมี&nbsp;<i class="icon-checkmark verified-profile"></i> </li>
      <li>ไม่ควรเลือกสินค้าที่มีราคาถูกกว่าท้องตลาดจนเกินจริง</li>
    </ul>
  </div>
</div>
<div class="full-width" id="full-line">
  <button class="flat-btn align-left padding-10" id="2">การสั่งซื้อสินค้า&nbsp;<small class="icon-arrow-down"></small></button>
  <div class="panel padding-15-bottom" id="panel2">
    <ul class="no-margin" style="list-style-type: decimal">
      ...
      <li>ถ้าหากต้องการยืนยันการสั่งซื้อให้ไปที่ รถเข็น <i class="icon-cart"></i></li>
    </ul>
  </div>
</div>
<div class="full-width" id="full-line">
  <button class="flat-btn align-left padding-10" id="3">ยืนยันการสั่งซื้อและการใช้โค๊ดโปรโมชั่น&nbsp;<small class="icon-arrow-down"></small></button>
  <div class="panel padding-15-bottom" id="panel3">
    <ul class="no-margin" style="list-style-type: decimal">
      <i class="font-red">**การชำระเงินเป็นแบบแยกตามร้าน มิใช่การชำระทีเดียวทั้งหมด</i>
      <li>ไปที่ รถเข็น <i class="icon-cart"></i></li>
...
<div class="full-width" id="full-line">
  <button class="flat-btn align-left padding-10" id="4">การชำระเงิน&nbsp;<small class="icon-arrow-down"></small></button>
  <div class="panel padding-15-bottom" id="panel4">
    <ul class="no-margin" style="list-style-type: decimal">
      ...
      <li>ให้แจ้งผู้ขายว่าคุณได้ทำการชำระเงินแล้ว <u>ผ่านทางลิงค์ในอีเมลของคุณ</u> หรือ <u>แจ้งผ่านทางเว็บไซต์</u>โดยไปที่ <i class="icon-menu"></i> และ <strong>รายการสั่งซื้อ</strong> <i class="icon-order"></i></li>
      <i class="font-red">**การจ่ายเงินให้ร้านค้าที่มิใช่ร้านค้าซึ่งได้รับการยืนยันแล้ว <i class="icon-checkmark verified-profile"></i> หากเกิดความเสียหายหรือผิดพลาดประการใด Closet จะไม่มีการชดใช้หรือรับผิดใดๆทั้งสิ้น</i>
...
<div class="full-width" id="full-line">
  <button class="flat-btn align-left padding-10" id="5">รีวิวร้านค้า&nbsp;<small class="icon-arrow-down"></small></button>
...
<div class="full-width" id="full-line">
  <button class="flat-btn align-left padding-10" id="5">การยกเลิกการสั่งซื้อ&nbsp;<small class="icon-arrow-down"></small></button>
  <div class="panel padding-15-bottom" id="panel5">
    <ul class="no-margin" style="list-style-type: decimal">
      <i class="font-red">**การยกเลิกรายการสั่งซื้อนั้นทำได้เฉพาะตอนยังไม่ชำระเงินเท่านั้น</i>
      <li>
        หากต้องการยกเลิกการสั่งซื้อ คุณสามารถทำได้ผ่านทางเว็บไซต์ โดยไปที่เมนู <i class="icon-menu"></i> และไปที่ <strong>รายการสั่งซื้อ</strong> หารายการที่ต้องการและคลิก <strong>ยกเลิกรายการสั่งซื้อนี้</strong>
      </li>
    </ul>
  </div>
</div>
...
<div class="full-width" id="full-line">
  <button class="flat-btn align-left padding-10" id="6">แจ้งปัญหาสินค้าหรือผู้ขาย&nbsp;<small class="icon-arrow-down"></small></button>
  <div class="panel padding-15-bottom" id="panel6">
    <ul class="no-margin" style="list-style-type: decimal">
      ...
      <li><strong>แจ้งปัญหาสินค้า</strong>&nbsp; สามารถทำได้โดยเข้าไปที่หน้าแสดงสินค้า ด้านล่างของชื่อผู้ขาย ให้คลิก <i class="icon-sub-menu"></i> และ <strong>แจ้งปัญหา</strong></li>
    </ul>
  </div>
</div>
@endsection
