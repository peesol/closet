...
export default {
    ...
    methods: {
            ...
            toggleShowProduct(contactId){
              this.$http.put(this.url + '/' + this.$root.shopSlug + '/edit/info/' + contactId + '/show_product').then((response)=> {
                  toastr.success(this.$trans.translation.saved);
              }, (response) => {
                  toastr.error(this.$trans.translation.error);
              });
            ...
            toggleShowCover(contactId){
              this.$http.put(this.url + '/' + this.$root.shopSlug + '/edit/info/' + contactId + '/show_cover').then((response)=> {
                  toastr.success(this.$trans.translation.saved);
              }, (response) => {
                  toastr.error(this.$trans.translation.error);
              });
            ...
            remove(contactId, index){
              ...
              this.$http.delete(this.url + '/' + this.$root.shopSlug + '/edit/info/' + contactId + '/delete').then((response)=> {
