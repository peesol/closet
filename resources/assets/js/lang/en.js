export default {
    ...
    everyday: 'Everyday',
    weekday: 'Weekday',
    shipping_methods_add: 'Add a shipping method',
    shipping_promotion: 'Shipping promotion',
    shipping_promotion_input: {
      label: 'Free shipping when buying/spend more than',
      placeholder: 'cost/quantity',
      cost: 'baht',
      qty: 'products',
    },
    cancle_promotion: 'Cancle promotion',
